...
Original file is located at
    https://colab.research.google.com/drive/1uiApjJtPl9gwnBRKiggumLZQmlGhSE1b
"""
...
def decode_audio(audio_binary):
  ...
  audio = audio[0:16000]
  print("decode_audio:", audio.shape)
...
sample_file = data_dir/'no/output.wav'
...
output_ds = files_ds.map(get_waveform_and_label, num_parallel_calls=AUTOTUNE)
print("waveform mapping: ", output_ds)
output_ds = output_ds.map(get_spectrogram_and_label_id,  num_parallel_calls=AUTOTUNE)
print("spec mapping: ",output_ds)
sample_ds = output_ds
'''
...
for spectrogram, label in sample_ds.batch(1):
  ...
  f = tf.nn.softmax(prediction[0])
  print(tf.argmax(f), commands[label[0]])
...
def get_live_input():
  ...
  NFRAMES = int((RATE * RECORD_SEC) / CHUNK)
